...
// check out http://stackoverflow.com/questions/18413309/how-to-implement-a-viewpager-with-different-fragments-layouts
...
public class MainActivity extends FragmentActivity implements ActionBar.TabListener {
    ...
    // END_INCLUDE (fragment_pager_adapter)
        ...
        public Fragment getItem(int position) {
            switch(position)
            {
            case 0: return new ArmFragment();
            case 1: return new HandFragment();
            case 2: return new ActionsFragment();
            default: return new ArmFragment();
            }
        }
        ...
        public CharSequence getPageTitle(int position) {
            ...
            switch (position) {
                ...
                case 1:
                    return getString(R.string.Hand);
                case 2:
